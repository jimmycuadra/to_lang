...
Feedback is greatly appreciated. If you have any problems with *to_lang*, please open a new issue. Please include debugging output from using @String#translate@'s @:debug@ option, if relevant to your issue. If you'd like to fix bugs, add features, or improve the library in general, feel free to fork the project and send me a pull request with your changes.
